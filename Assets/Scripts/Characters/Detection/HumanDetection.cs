...
namespace Characters
{
    ...
    class AIHumanDetection : BaseDetection
    {
        public AIHumanDetection(BaseCharacter owner, bool enemiesOnly = false, bool titansOnly = true) : base(owner, enemiesOnly, titansOnly)
        {
        }
