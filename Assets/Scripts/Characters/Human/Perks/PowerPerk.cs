...
{
    class PowerPerk : BasePerk
    {
        public bool PerkEnabled => CurrPoints == MaxPoints;
        
        protected virtual float MaxPower => 100f;
        protected virtual float MinPower => 0f;
        protected virtual float PowerCost => 20f;
        protected virtual float LinearRecoveryRate => 10f;
        ...
        {
            UpdatePower();
            // bool hasPower = _currentPower >= PowerCost;
        ...
        {
            UpdatePower();
            _currentPower = Mathf.Clamp(_currentPower - PowerCost, MinPower, MaxPower);
