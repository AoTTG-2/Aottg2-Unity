...
public static class ClothFactory
{
    ...
    {
        Cloth[] clothArray = UnityEngine.Object.FindObjectsByType<Cloth>(FindObjectsInactive.Include, FindObjectsSortMode.None);
    ...
    private static GameObject GenerateCloth(GameObject go, string res)
    {
        ...
        SkinnedMeshRenderer component = ((GameObject) UnityEngine.Object.
            Instantiate(ResourceManager.LoadAsset(ResourcePaths.Characters, res, true))).GetComponent<SkinnedMeshRenderer>();
