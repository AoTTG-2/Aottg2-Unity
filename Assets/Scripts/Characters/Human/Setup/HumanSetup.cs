    ...
    class HumanSetup: MonoBehaviour
    {
        ...
        public void CreateParts()
        {
            var bodyMaterial = HumanSetupMaterials.GetCostumeMaterial(_textures.GetBodyMainTexture(), _textures.GetBodyMaskTexture(),
                _textures.GetBodyColorTexture(), _textures.GetBodyPantsTexture(), CustomSet.InnerColor.Value.ToColor(), CustomSet.OuterColor.Value.ToColor(), CustomSet.PantsColor.Value.ToColor(), CustomSet.JacketColor.Value.ToColor(), CustomSet.BootsColor.Value.ToColor());
            CreateHead();
