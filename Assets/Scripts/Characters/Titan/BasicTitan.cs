...
namespace Characters
{
    class BasicTitan : BaseTitan
    {
        ...
        {
            this.targetHeadRotation = BasicCache.Head.rotation;
            if (target != null)
            {
                ...
                targetHeadRotation = Quaternion.Euler(BasicCache.Head.rotation.eulerAngles.x + num2,
            ...
            this.BasicCache.Head.rotation = this.oldHeadRotation;
            // _oldHeadRotation = BasicCache.Head.rotation;
        }
