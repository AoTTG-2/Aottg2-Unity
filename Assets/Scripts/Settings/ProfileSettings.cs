...
namespace Settings
{
    class ProfileSettings: SaveableSettingsContainer
    {
        ...
        public NameSetting Name = new NameSetting("GUEST" + UnityEngine.Random.Range(0, 100000), maxLength: 200, maxStrippedLength: 31);
        public NameSetting Guild = new NameSetting(string.Empty, maxLength: 200, maxStrippedLength: 31);
