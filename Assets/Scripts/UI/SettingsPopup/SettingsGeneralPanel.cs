...
namespace UI
{
    class SettingsGeneralPanel: SettingsCategoryPanel
    {
        ...
        public override void Setup(BasePanel parent = null)
        {
            ...
            // Temp
            ElementFactory.CreateDropdownSetting(DoublePanelLeft, style, settings.ColliderFix, "Collider", new string[] { "Original", "Small", "Combine" }, elementWidth: 160f, tooltip: "Requires restart.");
            ElementFactory.CreateToggleSetting(DoublePanelRight, style, settings.OnCollisionEnterFix, "OnCollisionEnter");
            ElementFactory.CreateToggleSetting(DoublePanelRight, style, settings.WallSlideFix, "IgnoreWallslide");
        }   
    }
}
