...
## Methods
#### function <mark style="color:yellow;">MoveTo</mark>(position: <mark style="color:blue;">[Vector3](../objects/Vector3.md)</mark>, range: <mark style="color:blue;">float</mark>, ignoreEnemies: <mark style="color:blue;">bool</mark>) 薔 <mark style="color:blue;">null</mark>
...
#### function <mark style="color:yellow;">Target</mark>(enemyObj: <mark style="color:blue;">Object</mark>, focus: <mark style="color:blue;">float</mark>) 薔 <mark style="color:blue;">null</mark>
...
#### function <mark style="color:yellow;">Idle</mark>(time: <mark style="color:blue;">float</mark>) 薔 <mark style="color:blue;">null</mark>
...
#### function <mark style="color:yellow;">Wander</mark>() 薔 <mark style="color:blue;">null</mark>
> Causes the (AI) titan to cancel any move commands and begin wandering randomly.

#### function <mark style="color:yellow;">Blind</mark>() 薔 <mark style="color:blue;">null</mark>
> Causes the titan to enter the blind state.

#### function <mark style="color:yellow;">Cripple</mark>(time: <mark style="color:blue;">float</mark>) 薔 <mark style="color:blue;">null</mark>
