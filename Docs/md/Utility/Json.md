...
### Static Methods
<pre class="language-typescript"><code class="lang-typescript">function LoadFromString(json: string) -> <a data-footnote-ref href="#user-content-fn-119">Object</a></code></pre>
...
<pre class="language-typescript"><code class="lang-typescript">function SaveToString(obj: <a data-footnote-ref href="#user-content-fn-119">Object</a>) -> string</code></pre>
