...
> 
<pre class="language-typescript"><code class="lang-typescript">function SetWeight(anim: string, weight: float)</code></pre>
...
> 
<pre class="language-typescript"><code class="lang-typescript">function GetWeight(anim: string) -> float</code></pre>
