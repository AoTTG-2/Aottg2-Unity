...
|---|---|---|---|
|Force|string|True|Force mode: applies force continuously over time.|
|Acceleration|string|True|Acceleration mode: applies force as acceleration, ignoring mass.|
|Impulse|string|True|Impulse mode: applies force instantly as an impulse.|
|VelocityChange|string|True|VelocityChange mode: applies force as a direct velocity change, ignoring mass.|
