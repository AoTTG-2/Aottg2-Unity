...
> 
<pre class="language-typescript"><code class="lang-typescript">function SpawnTitans(type: string, count: int) -> <a data-footnote-ref href="#user-content-fn-4">List</a></code></pre>
> Spawn titans
> 
...
> 
<pre class="language-typescript"><code class="lang-typescript">function SpawnTitansAt(type: string, count: int, position: <a data-footnote-ref href="#user-content-fn-9">Vector3</a>, rotationY: float = 0) -> <a data-footnote-ref href="#user-content-fn-4">List</a></code></pre>
