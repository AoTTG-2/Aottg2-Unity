...
> 
<pre class="language-typescript"><code class="lang-typescript">function GetProperty(property: string, defaultValue: <a data-footnote-ref href="#user-content-fn-82">Object</a>) -> <a data-footnote-ref href="#user-content-fn-82">Object</a></code></pre>
