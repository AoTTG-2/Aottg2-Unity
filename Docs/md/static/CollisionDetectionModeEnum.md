...
|---|---|---|---|
|Discrete|string|True|Discrete collision detection mode.|
|Continuous|string|True|Continuous collision detection mode.|
|ContinuousDynamic|string|True|ContinuousDynamic collision detection mode.|
|ContinuousSpeculative|string|True|ContinuousSpeculative collision detection mode.|
