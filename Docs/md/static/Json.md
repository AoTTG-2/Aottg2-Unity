...
### Static Methods
<pre class="language-typescript"><code class="lang-typescript">function LoadFromString(json: string) -> <a data-footnote-ref href="#user-content-fn-82">Object</a></code></pre>
> Loads a json string into a custom logic object.
> 
> **Parameters**:
> - `json`: The json string to load.
> 
<pre class="language-typescript"><code class="lang-typescript">function SaveToString(obj: <a data-footnote-ref href="#user-content-fn-82">Object</a>) -> string</code></pre>
