...
|---|---|---|---|
|Thunder|string|True|Thunder sound.|
|ErenRoar|string|True|ErenRoar sound.|
|AnnieRoar|string|True|AnnieRoar sound.|
|AnnieHurt|string|True|AnnieHurt sound.|
|ColossalSteam1|string|True|ColossalSteam1 sound.|
|ColossalSteam2|string|True|ColossalSteam2 sound.|
