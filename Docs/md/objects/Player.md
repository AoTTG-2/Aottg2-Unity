...
|Team|string|True|Player's chosen team. Note that this may be different from the character's final team (Character.Team field) if the character's team field is modified. Refer to [TeamEnum](../static/TeamEnum.md)|
|Status|string|True|Player's spawn status. Refer to [PlayerStatusEnum](../static/PlayerStatusEnum.md)|
|CharacterType|string|True|Player's chosen character. Refer to [CharacterTypeEnum](../static/CharacterTypeEnum.md)|
|Loadout|string|True|Player's chosen loadout. Refer to [LoadoutEnum](../static/LoadoutEnum.md)|
...
### Methods
<pre class="language-typescript"><code class="lang-typescript">function GetCustomProperty(property: string) -> <a data-footnote-ref href="#user-content-fn-82">Object</a></code></pre>
...
> 
<pre class="language-typescript"><code class="lang-typescript">function SetCustomProperty(property: string, value: <a data-footnote-ref href="#user-content-fn-82">Object</a>)</code></pre>
