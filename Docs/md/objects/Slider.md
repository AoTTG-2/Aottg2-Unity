...
|Direction|string|False|The direction of the slider. Refer to [SliderDirectionEnum](../static/SliderDirectionEnum.md)|
...
### Methods
<pre class="language-typescript"><code class="lang-typescript">function OnValueChanged(valueChangedEvent: function) -> <a data-footnote-ref href="#user-content-fn-72">Slider</a></code></pre>
...
> 
<pre class="language-typescript"><code class="lang-typescript">function SetValueWithoutNotify(value: <a data-footnote-ref href="#user-content-fn-82">Object</a>)</code></pre>
