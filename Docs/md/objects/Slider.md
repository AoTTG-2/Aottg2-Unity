...
### Methods
<pre class="language-typescript"><code class="lang-typescript">function OnValueChanged(valueChangedEvent: function) -> <a data-footnote-ref href="#user-content-fn-53">Slider</a></code></pre>
...
> 
<pre class="language-typescript"><code class="lang-typescript">function SetValueWithoutNotify(value: <a data-footnote-ref href="#user-content-fn-57">Object</a>)</code></pre>
