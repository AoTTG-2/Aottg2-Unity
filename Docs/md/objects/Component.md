...
|---|---|---|---|
|MapObject|[MapObject](../Entities/MapObject.md)|True|The MapObject the component is attached to.|
|NetworkView|[NetworkView](../Entities/NetworkView.md)|True|The NetworkView attached to the MapObject, if Networked is enabled.|
