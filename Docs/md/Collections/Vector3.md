...
> - `z`: The Z component.
> 
<pre class="language-typescript"><code class="lang-typescript">function Scale(scale: <a data-footnote-ref href="#user-content-fn-119">Object</a>) -> <a data-footnote-ref href="#user-content-fn-9">Vector3</a></code></pre>
